...
export default function DropDownInput(props) {
    const {id, value, defaultValue, options, placeholder, onChange, onFocus, iconDropdown} = props;

    return (
        <Select
            {...{id, placeholder, onFocus, defaultValue}}
            value={value !== '' ? value : undefined}
            className={cn(style.container, {[style.iconDropdown]: iconDropdown})}
            dropdownClassName={style.dropdown}
            suffixIcon={<img src={iconDropdown ? dropdown : arrows} alt="arrow" className={style.arrow}/>}
