...
export default class Form extends PureComponent {
    ...
    initData() {
        ...
        initialData = {...(propsData ? propsData : initialData), ...this.getDefaultValues(this.transformedChildren)};
        ...
        */
        ...
        return React.Children.map(children, element => {
            ...
            case Field: {
                ...
                if (ignore || !type) {
                    const {wrapperClass} = newElement.props;
                ...
                if (generateError) {
                    ...
                    this.errorGenerators[name] = value => (!value || !value.length) && FORM_ERROR_REQUIRED;
                }

                let onFieldChange = value => this.onFieldChange(name, value, onChange);
                if (overwriteChange) {
                    onFieldChange = value => this.onFieldChange(name, overwriteChange(value), onChange);
                }
                ...
                return React.cloneElement(newElement, {
                    wrapperClass: cn(style.field, wrapperClass),
                    name,
                    beforeUnmount: cleanOnDestroy ? () => this.onFieldDestroy(name, beforeUnmount) : null,
